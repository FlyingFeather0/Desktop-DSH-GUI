# Build the WPF glass preview demo.
...
$out = Join-Path $base 'WpfGlassPreview.exe'
$src = Join-Path $base 'WpfGlassPreview.cs'
...
if ($LASTEXITCODE -ne 0) {
  throw 'WPF preview compilation failed.'
}
Write-Host 'WPF Glass Preview created:' $out
