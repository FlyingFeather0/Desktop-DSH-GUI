# Build the WPF main window preview.
...
$out = Join-Path $base 'WpfMainPreview.exe'
$src = Join-Path $base 'WpfMainPreview.cs'
...
if ($LASTEXITCODE -ne 0) {
  throw 'WPF main preview compilation failed.'
}
Write-Host 'WPF Main Preview created:' $out
